...
Our TCP model abides by the TCP standard for connection setup and teardown. Our data transmission state has been slightly simplified to adapt to promela.
